...
export function generateMarketScrapedMaterials(
  ...
  const allItems: MarketScrapedItem[] = [
    ...
    {
      id: 'mat-spc-1',
      name: 'Кварцвинил замковый SPC 4 мм Tarkett / Alpine Floor 43 класс',
      brand: 'Tarkett',
      category: 'mixes',
      categoryLabel: 'Напольные покрытия',
      storeName: '12 Месяцев',
      ...
      unitPriceKzt: 7800,
      requiredQty: area,
      totalCostKzt: area * 7800,
      sku: '12M-SPC-TKT-43',
      inStock: true,
      packageTier: 'optimal',
      specification: '100% влагостойкий, антискользящий, синхротиснение структуры дуба.',
      scrapedStatus: 'В наличии (склад 12 Месяцев, пр. Богенбай Батыра)',
    },
    {
      id: 'mat-coll-1',
      name: 'Комплект коллекторный в сборе Valtec / Rehau 4 выхода с расходомерами',
      brand: 'Rehau / Valtec',
      category: 'plumbing',
      categoryLabel: 'Сантехника и ОВК',
      storeName: 'Строймарт',
      storeUrl: 'https://stroy-mart.kz/kollektornye-gruppy/',
      storeLogoCode: 'stroymart',
      unit: 'комплект',
      unitPriceKzt: 88000,
      requiredQty: 2,
      ...
      inStock: true,
      packageTier: 'optimal',
      specification: 'Латунный коллекторный блок с отсечными кранами и термоманометрами.',
      scrapedStatus: 'Официальный склад Строймарт (Астана)',
    },
    {
      id: 'mat-inst-1',
      name: 'Инсталляция для подвесного унитаза Geberit Duofix Delta с клавишей смыва',
      ...
      inStock: true,
      packageTier: 'optimal',
      specification: 'Бесшовная рама до 400 кг нагрузки, бачок с защитой от конденсата.',
      scrapedStatus: 'Быстрая доставка Kaspi',
    },
    {
      id: 'mat-tile-1',
      name: 'Клей плиточный усиленный эластичный Ceresit CM 14 Extra (25 кг)',
      brand: 'Ceresit',
      category: 'mixes',
      categoryLabel: 'Смеси и полы',
      storeName: '12 Месяцев',
      storeUrl: 'https://www.12months.kz/catalog/kley-dlya-plitki/',
      storeLogoCode: '12m',
      unit: 'мешок 25 кг',
      unitPriceKzt: 4200,
      requiredQty: Math.max(10, Math.round(area * 0.42)),
      totalCostKzt: Math.max(10, Math.round(area * 0.42)) * 4200,
      sku: '12M-CRS-CM14-25',
      inStock: true,
      packageTier: 'optimal',
      specification: 'Класс C1 TE по ГОСТ. Для керамогранита и теплых полов.',
      scrapedStatus: 'Остаток: 180 мешков (12 Месяцев)',
    },
    {
      id: 'mat-putty-1',
      name: 'Шпаклевка финишная полимерная Knauf Полимер Финиш (20 кг)',
      brand: 'Knauf',
      category: 'mixes',
      categoryLabel: 'Смеси и полы',
      storeName: '12 Месяцев',
      storeUrl: 'https://www.12months.kz/catalog/shpaklevka/',
      storeLogoCode: '12m',
      unit: 'мешок 20 кг',
      unitPriceKzt: 4600,
      requiredQty: Math.max(8, Math.round(quantities.wall_area_sqm / 8)),
      totalCostKzt: Math.max(8, Math.round(quantities.wall_area_sqm / 8)) * 4600,
      sku: '12M-KNF-POLFIN-20',
      inStock: true,
      packageTier: 'optimal',
      specification: 'Белоснежная суперпластичная шпаклевка под боковой проявочный свет.',
      scrapedStatus: 'Свежая партия 2026 г.',
    },
    {
      id: 'mat-primer-1',
      name: 'Грунтовка глубокого проникновения Knauf Тифенгрунд (10 л)',
      brand: 'Knauf',
      category: 'mixes',
      categoryLabel: 'Смеси и полы',
      storeName: '12 Месяцев',
      ...
      inStock: true,
      packageTier: 'all',
      specification: 'Укрепляет основание, обеспыливает, снижает впитываемость стяжки.',
      scrapedStatus: 'В наличии в 12 Месяцев',
    },
    {
      id: 'mat-corrug-1',
      name: 'Труба гофрированная ПВХ 20 мм с протяжкой (бухта 100 м)',
      brand: 'Промрукав / IEK',
      category: 'electrical',
      categoryLabel: 'Электромонтаж',
      storeName: '12 Месяцев',
      storeUrl: 'https://www.12months.kz/catalog/truba-gofrirovannaya/',
      storeLogoCode: '12m',
      unit: 'бухта 100 м',
      unitPriceKzt: 14500,
      requiredQty: Math.ceil(cable3x25Qty / 100),
      totalCostKzt: Math.ceil(cable3x25Qty / 100) * 14500,
      sku: '12M-GOF-PVC-20',
      inStock: true,
      packageTier: 'all',
      specification: 'Негорючая самозатухающая гофра для скрытой проводки по потолку.',
      scrapedStatus: 'В наличии на складе',
    },
    {
      id: 'mat-boxes-1',
      name: 'Подрозетники Schneider Electric углубленные 68х60 мм для бетона/ГКЛ',
      brand: 'Schneider Electric',
      category: 'electrical',
      categoryLabel: 'Электромонтаж',
      storeName: 'Kaspi Магазин',
      storeUrl: 'https://kaspi.kz/shop/c/junction-boxes/',
      storeLogoCode: 'kaspi',
      unit: 'шт',
      unitPriceKzt: 420,
      requiredQty: quantities.electrical_points,
      totalCostKzt: quantities.electrical_points * 420,
      sku: 'KSP-SCH-PODR-68',
      inStock: true,
      packageTier: 'all',
      specification: 'Соединение в блоки, жесткий огнестойкий пластик с направляющими.',
      scrapedStatus: 'В наличии в Kaspi',
    },
    {
      id: 'mat-damp-1',
      name: 'Демпферная лента 100х8 мм с фартуком (рулон 25 м)',
      brand: 'Тилит',
      category: 'insulation',
      categoryLabel: 'Изоляция',
      storeName: '12 Месяцев',
      storeUrl: 'https://www.12months.kz/catalog/izolyatsiya/',
      storeLogoCode: '12m',
      unit: 'рулон 25 м',
      unitPriceKzt: 4800,
      requiredQty: Math.ceil(quantities.perimeter_m / 25),
      totalCostKzt: Math.ceil(quantities.perimeter_m / 25) * 4800,
      sku: '12M-DAMP-TILT-25',
      inStock: true,
      packageTier: 'all',
      specification: 'Компенсация температурного расширения стяжки по всему периметру.',
      scrapedStatus: 'В наличии в 12 Месяцев',
    },
  ];
